...
if (isset($_SESSION['ctfcookies']) && isset($_SESSION['ctfId'])) {
    ...
    $requete = $connexion->prepare("SELECT flag1, flag2, flag3, time_flag_1 , time_flag_2 , time_flag_3 FROM prog WHERE cookie = ?");
...
<?php if($flag1 != 0){
    ...
    echo "<div class='box1' onclick='location.href=`./prog/etape1.php`;' ><span class='text'>HTML</span></div>"; 
}; 
if($flag2 != 0){
    echo "<div class='box2end'><span class='text'>$time2</span></div>";
}else{
    echo "<div class='box2' onclick='location.href=`./prog/etape2.html`;'><span class='text'>CSS</span></div>";
}
if($flag3 != 0){
    echo "<div class='box3end'><span class='text'>$time3</span></div>";
}else{
    echo "<div class='box3' onclick='location.href=`./prog/etape3.html`;'><span class='text'>SQL</span></div>";
}?>
</body>
</html>