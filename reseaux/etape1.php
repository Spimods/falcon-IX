...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key1 FROM timersociaux WHERE cookie = ?");
...
<div class="loading-bar">
    ...
    <div class="time" id="time">0:00</div>
        ...
        <div class="back">
        <span class="question">Où est née Héloïse Brunauld ?</span>
...
function redirect(){
    window.location.href = "save.php?nombre=" + essai;
}
