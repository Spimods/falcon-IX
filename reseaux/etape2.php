...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key2 FROM timersociaux WHERE cookie = ?");
...
<div class="loading-bar">
    ...
    <div class="time" id="time">0:00</div>
        ...
        <div class="back">
        <span class="question">Quel est le compte de l'entreprise d'Héloïse ?</span>
...
function verifierValeur() {
    ...
    if ("ySabDYrQsyFIXVcy6G+yhA==" == encryptValue(valeur, 1990) || "6PMPoog2YWYJJkGD1nZT26Owv1r9FSMBxLyxTwNinok=" == encryptValue(valeur, 1990) || "+STbIhhFSVGogHCCJqtuSw==" == encryptValue(valeur, 1990) || "ag55PolnKQizG+gJ2xmehg==" == encryptValue(valeur, 1990)) {
...
function redirect(){
    window.location.href = "save2.php?nombre=" + essai;
}
