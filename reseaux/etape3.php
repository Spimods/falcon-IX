...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key3 FROM timersociaux WHERE cookie = ?");
...
<div class="loading-bar">
    ...
    <div class="time" id="time">0:00</div>
        ...
        <div class="back">
        <span class="question">Qui est l'ex-petit ami d'Héloïse ?</span>
...
function verifierValeur() {
    ...
    if ("XTAdbZ7ce4cqYdllKGAsQA==" == encryptValue(valeur, 1990) || "oa7GGAfg41T4CElUaTgmGw==" == encryptValue(valeur, 1990) || "fxYCaum2BaV+6J0ygzCbcQ==" == encryptValue(valeur, 1990) || "8naEd1lpcaGK6qnsffp77A==" == encryptValue(valeur, 1990) || "WBsXD9DMTg5SCcHld2xn7g==" == encryptValue(valeur, 1990) || "IKHs9jugfU3A8r3KQc5J0Q==" == encryptValue(valeur, 1990)) {
...
function redirect(){
    window.location.href = "save3.php?nombre=" + essai;
}
