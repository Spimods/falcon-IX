...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key6 FROM timersociaux WHERE cookie = ?");
    ...
    if ($valeur1 == 1) {
        ...
        $requeteverif->close();
        $requete = $connexion->prepare("SELECT time6 FROM timersociaux WHERE cookie = ?");
        ...
        $requete2->execute();
        $requete3 = $connexion->prepare("SELECT time1, time2, time3, time4 ,time5 FROM timersociaux WHERE cookie = ?");
        ...
        $requete3->close();
        $requete4 = $connexion->prepare("UPDATE rsociaux SET time_flag_3 = ?, flag3 = 1 WHERE cookie = ?");
        $requete4->bind_param("ss",$time, $idcookie);
        $requete4->execute();    
        $requete5 = $connexion->prepare("UPDATE timersociaux SET time6 = ?, key6 = 1  WHERE cookie = ?");
