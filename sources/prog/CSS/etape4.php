...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key4 FROM timeprog WHERE cookie = ?");
...
<div id="tooltip">
    ...
    <script>
        ...
        function checkCSS() {
            ...
            console.log(rightPercentage, heightPixels, borderRadiusPercentage, widthPixels, backimage, backsizeimage, backrepeatimage, border, filter);
            if (rightPercentage === '40%' && borderRadiusPercentage === '100%' && widthPixels === '100px' && heightPixels === '100px' && backcolor == 'rgb(255, 255, 0)' && backrepeatimage == 'no-repeat' && backsizeimage == 'cover' && backimage == 'url("http://localhost/falcon-V/images/image.png")' && border == '4px solid rgb(255, 0, 0)' && filter == 'blur(2px) brightness(0.8)') {
