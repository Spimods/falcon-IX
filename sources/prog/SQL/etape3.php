...
if (isset($_SESSION['ctfcookies'])) {
    ...
    $requeteverif = $connexion->prepare("SELECT key3 FROM timeprogsql WHERE cookie = ?");
...
<body>
    <div class="editor">
            <div id="editor" style="left: -10%; height: 210px; width: 30%; margin-bottom: 1em;">SELECT * FROM users;</div>
<div id="tooltip">
            <p>Informations :</p>
            <ul>
                <li>Cette requête SQL sélectionne toutes les colonnes de la table "users", récupérant ainsi toutes les données enregistrées dans cette table.</li>
            </ul>
        </div>
